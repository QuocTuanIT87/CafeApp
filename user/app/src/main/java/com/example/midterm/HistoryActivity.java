...
import com.example.midterm.Adapter.HistoryOrderAdapter;
...
public class HistoryActivity extends AppCompatActivity implements HistoryOrderAdapter.OnItemClickListener {
    ...
    public void onDetailButtonClick(Order order) {
        ...
        Intent intent = new Intent(HistoryActivity.this, DetailOrderActivity.class);
